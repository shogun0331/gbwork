...
namespace GB
{
    ...
    public static class EditorGUIUtil 
    {
        ...
        public static void DrawSectionStyleLabel(string text, int fontSz = 18){GUILayout.Label(text, CustomSectionStyle(fontSz));}
        ...
        static GUIStyle CustomSectionStyle(int fontSz = 18)
        {
            GUIStyle style = new GUIStyle(GUI.skin.label);
